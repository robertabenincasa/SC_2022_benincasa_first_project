...
and only one 0, i.e. only dead cells except for one.
...
def evolve(stato):
""" This function perfoms the evolution of each state following the chosen rule and exploiting the boundary conditions that one chooses to adopt.

The rule can be rule 30, 90, 110 or 184. The boundaries can be reflective, periodic or constant. 
